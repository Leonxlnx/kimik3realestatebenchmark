...
const K = [
  ...
  // --- swing wide west; the terrace and pool open up
  { t: 0.375, p: [-9, 14.4, 127.5], l: [-18, 13.5, 110] },
  { t: 0.395, p: [-16.5, 14.2, 116], l: [-8, 13.5, 103] },
  { t: 0.42, p: [-12, 13.9, 104], l: [4, 14.4, 100.5] },
